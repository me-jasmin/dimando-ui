...
(function () {
    ...
    function k(Z) {
        ...
        function W(al) {
            var aj = al.source.match(
                new RegExp('(?:\\[(?:[^\\x5C\\x5D]|\\\\[\\s\\S])*\\]|\\\\u[A-Fa-f0-9]{4}|\\\\x[A-Fa-f0-9]{2}|\\\\[0-9]+|\\\\[^ux0-9]|\\(\\?[:!=]|[\\(\\)\\^]|[^\\x5B\\x5C\\(\\)\\^]+)', 'g')
            );
            var ah = aj.length;
            var an = [];
    ...
    c(i({ keywords: r, hashComments: 3, cStyleComments: true, multilineStrings: true, tripleQuotedStrings: true, regexLiterals: true }), ['coffee']);
    c(g([], [[C, /^[\s\S]+/]]), ['regex']);
    function d(V) {
